## MiNK - an _m,n,k_-game bot written in Java

Hello there! This is MiNK, an _m,n,k_-game bot that runs in console and is made entirely in Java! It supports _m,n,k_-games up to a 26,26,26-game (due to it featuring a coordinate system that works using ASCII). It uses the principles of reinforcement learning to train itself dynamically, then will play the user in the _m,n,k_-game of their choice.
